module PcfgTransforms.Domains exposing (domains)
...
transformName name =
  let output = concatForms [name, comma, epithet]
      ...
      domain = pickWeightedForm
        ...
        , (1.0, literalForm "Beetles")
        , (1.0, literalForm "Ants")
        , (1.0, literalForm "Fish")
        , (1.0, literalForm "Whales")
